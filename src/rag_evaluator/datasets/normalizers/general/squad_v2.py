...
class SquadV2Normalizer(DatasetNormalizer):
    """
    Normalizer for SQuAD 2.0 extractive and unanswerable QA records.
    """
    ...
    def normalize_record(
        ...
        *,
        ...
        return EvalSample(
            ...
            answer_aliases=[str(answer) for answer in answer_texts[1:]],
            question_type=QuestionType.FACTOID if is_answerable else QuestionType.UNANSWERABLE,
    ...
    def _answer_spans(self, record: dict[str, Any]) -> list[EvidenceSpan]:
        ...
        document_id = self.source_id(record, "id") or "squad_context"
